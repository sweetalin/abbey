 ...
 * 
 * @date 2015年5月26日 上午11:24:55
 * 
 * @description 
 **/
public class Ks3Socket extends Socket {
    private static final Log log = LogFactory.getLog(Ks3Socket.class);

    private final Socket sock;

    public Ks3Socket(Socket sock) {
        this.sock = sock;
